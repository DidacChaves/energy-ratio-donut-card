...
customElements.define('action-handler-energy-ratio-donut', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-energy-ratio-donut')) {
    return body.querySelector('action-handler-energy-ratio-donut') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-energy-ratio-donut');
